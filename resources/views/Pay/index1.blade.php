...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('wy/css/normalize.css')}}" />
    <link rel="stylesheet" href=" {{asset('wy/css/global.css')}}" />
    <!-- Load Stripe.js on your website. -->
    <script src="https://js.stripe.com/v3/"></script>
    <script src="{{asset('wy/script.js')}}}" defer></script>
    ...
    <script src="{{asset('wy/translation.js')}}" defer></script>
  </head>
