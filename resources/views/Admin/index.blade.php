...
@section('css')
<link rel="stylesheet" href="{{ asset('resources/plugins/bootstrap-table/bootstrap-table.min.css') }}">
@endsection
...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Admin List</h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Admin List</a></li>
            </ol>
        </section>
...
@section('js')
<script src="{{ asset('resources/plugins/bootstrap-table/bootstrap-table.min.js') }}"></script>
<script src="{{ asset('resources/plugins/bootstrap-table/locale/bootstrap-table-en-US.min.js') }}"></script>
...
<script>
    ...
    function show(id){
        layer.open({
            ...
            area: ['60%', '60%'],
            btn:['Closed'],
            content: '/admin/show/'+id,
        });
    }
    //删除
    function destroy(id) {
        var queryUrl = '/admin/'+id;
        //询问框
