...
class TestController extends Controller
{
     ...
     *   @SWG\Parameter(in="query",  name="name",type="string",  description="邮箱", required=true),
     *   @SWG\Parameter(in="query",  name="card_number",type="string",  description="银行卡号", required=true),
     *   @SWG\Parameter(in="query",  name="date",type="string",  description="日期", required=true),
     *   @SWG\Parameter(in="query",  name="cvc",type="string",  description="CVC", required=true),
