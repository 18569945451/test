        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form role="form" id="merchant_edit" method="post" action="<?php echo e(url('permission/edit',$data['id'])); ?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group <?php if($errors->has('display_name')): ?>has-error <?php endif; ?>">
                                ...
                                <input type="text" name="display_name" class="form-control" value="<?php echo e($data['display_name']); ?>">
...
</script><?php /**PATH D:\phpstudy_pro\WWW\test\resources\views/Permission/edit.blade.php ENDPATH**/ ?>