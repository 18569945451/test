        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form role="form" method="post" action="<?php echo e(url('role/add')); ?>" id="merchant_add" enctype="multipart/form-data">
                            ...
                            <div class="form-group <?php if($errors->has('display_name')): ?>has-error <?php endif; ?>">
                                <?php if($errors->has('display_name')): ?> <label class="control-label" for="inputError"><i class="fa fa-times-circle-o"></i> display_name</label><?php else: ?><label> display_name</label><?php endif; ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="permissions_id[]" value="<?php echo e($val->id); ?>">
                                        <?php echo e($val->display_name); ?>
...
<?php /**PATH D:\phpstudy_pro\WWW\test\resources\views/Role/add.blade.php ENDPATH**/ ?>