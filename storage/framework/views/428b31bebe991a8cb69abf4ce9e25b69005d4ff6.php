...
<div class="wrapper">
    ...
    <header class="main-header">
        <!-- Logo -->
        <a href="<?php echo e(asset('resources/index2.html')); ?>" class="logo">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?php echo e(asset('resources/dist/img/user2-160x160.jpg')); ?>" class="user-image" alt="User Image">
                            <span class="hidden-xs">Alexander Pierce</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- Admins image -->
                            <li class="user-header">
                                <img src="<?php echo e(asset('resources/dist/img/user2-160x160.jpg')); ?>" class="img-circle" alt="User Image">
                                <p>
...
<?php /**PATH D:\phpstudy_pro\WWW\test\resources\views/layouts/app.blade.php ENDPATH**/ ?>